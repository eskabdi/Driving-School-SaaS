...
-- Demo users per role
insert into public.users (id, tenant_id, role, status, full_name, email)
values
  ('00000000-0000-0000-0000-000000000101', '00000000-0000-0000-0000-000000000001', 'school_admin', 'active', 'Admin Demo', 'admin@acme-demo.test'),
  ('00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000001', 'instructor', 'active', 'Instructor Demo', 'instructor@acme-demo.test'),
  ('00000000-0000-0000-0000-000000000103', '00000000-0000-0000-0000-000000000001', 'learner', 'active', 'Learner Demo', 'learner@acme-demo.test'),
  ('00000000-0000-0000-0000-000000000104', '00000000-0000-0000-0000-000000000001', 'receptionist', 'active', 'Receptionist Demo', 'receptionist@acme-demo.test'),
  ('00000000-0000-0000-0000-000000000105', '00000000-0000-0000-0000-000000000001', 'accountant', 'active', 'Accountant Demo', 'accountant@acme-demo.test');
...
-- Demo vehicle
insert into public.vehicles (id, tenant_id, registration_plate, make_model, status)
values ('00000000-0000-0000-0000-000000003001', '00000000-0000-0000-0000-000000000001', 'AA-000-001', 'Toyota Corolla', 'active');

-- License categories per Proclamation 1074/2018
insert into public.license_categories (code, tenant_id, name, description, status)
values
  ('3', '00000000-0000-0000-0000-000000000001', 'Category 3', 'Light Vehicles', 'active'),
  ('4', '00000000-0000-0000-0000-000000000001', 'Category 4', 'Medium Vehicles', 'active'),
  ('5A', '00000000-0000-0000-0000-000000000001', 'Category 5A', 'Heavy Vehicles', 'active');

-- Demo course packages
insert into public.course_packages (id, tenant_id, license_category_code, name, total_hours, price, status)
values
  ('00000000-0000-0000-0000-000000004001', '00000000-0000-0000-0000-000000000001', '3', 'Basic Cat 3', 30, 9000, 'active'),
  ('00000000-0000-0000-0000-000000004002', '00000000-0000-0000-0000-000000000001', '4', 'Standard Cat 4', 40, 12000, 'active'),
  ('00000000-0000-0000-0000-000000004003', '00000000-0000-0000-0000-000000000001', '5A', 'Advanced Cat 5A', 50, 15000, 'active');
...
insert into public.lesson_assignments (id, tenant_id, lesson_id, learner_id, status)
values
  ('00000000-0000-0000-0000-000000007001', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000006001', '00000000-0000-0000-0000-000000001001', 'scheduled'),
  ('00000000-0000-0000-0000-000000007002', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000006002', '00000000-0000-0000-0000-000000001002', 'confirmed'),
  ('00000000-0000-0000-0000-000000007003', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000006004', '00000000-0000-0000-0000-000000001001', 'completed');
...
-- Demo payments
insert into public.payments (id, tenant_id, invoice_id, amount, method, status, idempotency_key)
values
  ('00000000-0000-0000-0000-000000009001', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000008002', 6000, 'cash', 'succeeded', '00000000-0000-0000-0000-000000009001'),
  ('00000000-0000-0000-0000-000000009002', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000008003', 9000, 'cash', 'succeeded', '00000000-0000-0000-0000-000000009002');

-- Demo refunds
insert into public.refunds (id, tenant_id, payment_id, amount, reason, status, approved_by)
values
  ('00000000-0000-0000-0000-000000010001', '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000009001', 1000, 'Partial lesson cancellation', 'approved', '00000000-0000-0000-0000-000000000105');
